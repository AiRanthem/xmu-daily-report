...
## 临时置顶公告！
最近打卡逻辑变更频繁，我在重新设计一套鲁棒性更强的逻辑以一劳永逸地应对现在莫名其妙增加需要填写内容的问题！

但是最近作者比较忙！而且开发涉及一系列配套服务，包括图形化配置界面、数据支持服务等，同时需要把整个项目进行面向对象重构，工作量比较大！最近打卡会失败！请大家耐心等待！

新版本本周内会上线！开发进度会每天晚上推到dev分支，有兴趣的同学可以去看一下，提点意见。
